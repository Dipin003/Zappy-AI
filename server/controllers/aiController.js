...
export const generateImage = async (req, res) => {
    ...
    try {
        ...
        if (plan !== 'premium') {
            return res.json({ sucess: false, message: "This feature is only available for premium users" })
        }
...
export const resumeReview = async (req, res) => {
    ...
    try {
        ...
        if (resume.size > 5 * 1024 * 1024) {
            return res.json({ sucess: false, message: "File size should be less than 5MB" })
        }
